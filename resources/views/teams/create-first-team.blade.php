<x-guest-layout>
    ...
    <div role="alert" class="text-red-700 bg-red-100 border border-t-0 border-red-400 rounded h-1/2">
            ...
            <div class="px-4 py-3 text-indigo-900 bg-gray-100 border-t-4 border-indigo-500 rounded-b shadow-md"
                ...
                <div class="flex">
                    ...
                    <div>
                        ...
                        <p class="text-sm">Go <a href="{{ route('join-team') }}" class="underline">here</a> for instructions on how to accept
                            the invitation.</p>
                    </div>
                </div>
            </div>
